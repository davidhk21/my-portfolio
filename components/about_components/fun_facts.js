    ...
    <div className={styles.funFactsContainer1}>
      ...
      <Fade distance="100px" delay={500} right>
        <div className={styles.funFactsInfoContainer}>
          ...
          <p>
            I have a mini poodle named Shadow. I can solve a 2x2, 3x3, and a 4x4 rubik&apos;s cube.
            For fun, I memorized the first 50 digits of pi one day during elementary school and somehow I still remember them to this day.
